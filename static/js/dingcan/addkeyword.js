		...
		$.post(url,null,function(data){
			$.each(data,function(i,v){
				...
				zsc_html = "<div class=\"edit-info\">"+
						   ...
						   "<img id=\"zsc_imgs0\" src=\"static/images/admin/bigimg.jpg\" width=\"295\" height=\"126\"/>"+
						   "<span id=\"zsc_titles0\">标题</span>"+
						   "<b class=\"modify\"><img id=\"zsc_simg0\""+
						   " src=\"static/images/admin/op-modify.png\" onclick=\"zsc_editimg(0)\"/></b>"+
						   ...
						   "<img src=\"static/images/admin/keywords_28.jpg\" class=\"add1\" "+
						   "style=\"cursor:pointer;\" onclick=\"zsc_addimg(1)\" />"+
						   "</div>"+
						   "</div>"+
						   "<div class=\"tuwen_right\">"+
						   "<img src=\"static/images/admin/keywords_15.jpg\">"+
						   "<p>"+
						   "<br />"+
						   ...
						   "</p>"+
						   "<img src=\"static/images/admin/keywords_19.jpg\">"+ 
						   "</div>"+
						   "<div style=\" padding-top:45px; clear:both;\">"+
						   "<a class=\"bnt cancel\" href=\"javascript:btnfalse(1);\"></a>"+
						   "<div onclick=\"btnsave(2,1)\" class=\"bnt updatebtn\" style=\"cursor:pointer;\"></div>"+
						   "</div>"+
						   "</div>"+
						   "</div>";
...
function zsc_addimg(num){
	if($('.simgcon').length<9){
		...
		var zsc_html = "<a href=\"javascript:;\" class=\"simgcon\" id=\"zsc_imgs"+num+"\">"+
					   "<span>标题</span>"+
					   "<img src=\"static/images/admin/smallimg.jpg\" id=\"zsc_simg"+num+"\" />"+
					   "<b class=\"smodify\"><img src=\"static/images/admin/op-modify.png\" onclick=\"zsc_editimg("+num+")\" />"+
					   "<img src=\"static/images/admin/op-del.png\" onclick=\"zsc_delimg("+num+")\" /></b>"+
...
function zsc_editimg(num){
	...
	if(0==zsc_count){
		$('#zsc_titles').val($('#zsc_titles0').html());
		$('#zsc_urls').val($('#zsc_urls0').val());
		if('static/images/admin/bigimg.jpg'==$('#zsc_imgs0').attr('src')){
			$('#zsc_imgurls').val();
		}else{
		...
		if('static/images/admin/smallimg.jpg'!=ssurl){
	...
	$('.addreply').click(function(){
		...
		if(flag){
			...
			zsc_html = "<div><h3>添加新的回复</h3></div>"+
					   ...
					   "</div>"+
					   "<div style=\" padding-top:45px; clear:both;\">" +
                       "<div onclick=\"btnsave(1,0)\" class=\"btn btn_submit \" style=\"cursor:pointer;\">保存</div>" +
					   "<div onclick=\"btnfalse(0)\" class=\"btn btn_submit\">取消</div>" +
					   ...
					   "</div>"+
					   "<div style=\" padding-top:45px; clear:both;\">"+
					   "<div onclick=\"btnsave(2,0)\" class=\"btn btn_submit \" style=\"cursor:pointer;\">保存</div>" +
					   "<div onclick=\"btnfalse(0)\" class=\"btn btn_submit\">取消</div>" +
					   "</div>"+
					   "</div>"+
					   "</div>";
