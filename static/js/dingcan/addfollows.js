...
$(function(){
	...
	zsc_html = "<div class=\"list\" style=\"position:relative\">"+
			   ...
			   "<div onclick=\"btnsave(1,0)\" class=\"save\" style=\"cursor:pointer;background:#318dd0;width:120px;height:45px;color:#fff;line-height: 45px;text-align: center;\">保存</div>"+
			   "</div>"+
			   "</div>"+
			   //图文信息
			   ...
			   "<div onclick=\"btnsave(2,0)\" class=\"save\" style=\"cursor:pointer;background:#318dd0;width:120px;height:45px;color:#fff;line-height: 45px;text-align: center;\">保存</div>"+
			   "</div>"+
			   "</div>"+
			   "</div>"+
			   "</div>";
