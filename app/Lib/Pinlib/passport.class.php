...
class passport
{
     ...
     * 注册新用户
     */
    public function register($username, $password, $email, $address, $phone_mob, $byear, $bmonth, $bday, $gender,$shares) {
        if (!$add_data = $this->_us->register($username, $password, $email, $address, $phone_mob, $byear, $bmonth, $bday, $gender,$shares)) {
